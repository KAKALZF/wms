...
<script type="text/javascript"
	src="/js/plugins/ztree/jquery.ztree.core-3.4.js"></script>
		...
		<div id="left_menu_cnt">
			...
			<div id="nav_resource">
				<ul id="dleft_tab1" class="ztree">
					...
					<%-- 	<li>
						<a href="#" class="system_url"
							data-url="<s:url namespace='/' action='employee'></s:url>">员工管理
						</a>
					</li>
					<li>
						<a href="#" class="system_url"
							data-url="<s:url namespace='/' action='department'></s:url>">部门管理
						</a>
					</li>
					<li>
						<a href="#" class="system_url"
							data-url="<s:url namespace='/' action='role'></s:url>">角色管理 </a>
					</li>
					<li>
						<a href="#" class="system_url"
							data-url="<s:url namespace='/' action='permission'></s:url>">权限管理
						</a>
					</li> --%>
				</ul>
